...
CATALOG_EXTRA = [
    dict(num=4,  titulo="Cariñito",                  compositor="Ángel Aníbal Rosado",       pdf="Carinito - Trompete Bb.pdf",                      source="omr", key_concert="", beats=2, beat_type=4, forma=["A", "B"]),
    dict(num=5,  titulo="Llorando se Fue",           compositor="Los Kjarkas (G. Hermosa)",  pdf="Llorando se Fue_Cumbias_TrompBb.pdf",             source="omr", key_concert="", beats=2, beat_type=4, forma=["A", "B"]),
    dict(num=6,  titulo="Danza de los Mirlos",       compositor="Los Mirlos",                pdf="Danza de los mirlos - Trompete 1_melodia.pdf",    source="omr", key_concert="", beats=2, beat_type=4, forma=["A", "B"]),
    dict(num=7,  titulo="La Danza del Petrolero",    compositor="(cumbia colombiana)",       pdf="La Danza del Petrolero-Trumpet_in_Bb.pdf",        source="omr", key_concert="", beats=2, beat_type=4, forma=["A", "B"]),
    dict(num=8,  titulo="Cumbia Sobre el Mar",       compositor="Rafael Mendoza",            pdf="Cumbia Sobre EL Mar - Trompete.pdf",              source="omr", key_concert="", beats=2, beat_type=4, forma=["A", "B"]),
    dict(num=9,  titulo="El Diablo",                 compositor="(cumbia)",                  pdf="El Diablo - Trompete Bb.pdf",                     source="omr", key_concert="", beats=2, beat_type=4, forma=["A", "B"]),
    dict(num=10, titulo="Constelación",              compositor="(cumbia)",                  pdf="Constelacion - Trompete Bb.pdf",                  source="omr", key_concert="", beats=2, beat_type=4, forma=["A", "B"]),
    dict(num=11, titulo="Elsa",                      compositor="(cumbia)",                  pdf="Elsa - Trompete Bb.pdf",                          source="omr", key_concert="", beats=2, beat_type=4, forma=["A", "B"]),
    dict(num=12, titulo="Cumbia da Praia",           compositor="(cumbia)",                  pdf="Cumbia da Praia - Trumpet in Bb.pdf",             source="omr", key_concert="", beats=2, beat_type=4, forma=["A", "B"]),
    dict(num=13, titulo="Cumbia del Desierto",       compositor="(cumbia)",                  pdf="Cumbia del Desierto_Cumbias_TrompBB1.pdf",        source="omr", key_concert="", beats=2, beat_type=4, forma=["A", "B"]),
    dict(num=14, titulo="Lobos al Escape",           compositor="Los Mirlos",                pdf="Lobos al escape-Trumpet_in_Bb.pdf",               source="omr", key_concert="", beats=2, beat_type=4, forma=["A", "B"]),
    dict(num=15, titulo="Baião do Deserto",          compositor="(baião)",                   pdf="Baiao Do Deserto- Trompete.pdf",                  source="omr", key_concert="", beats=2, beat_type=4, forma=["A", "B"]),
    dict(num=16, titulo="Ya se ha Muerto mi Abuelo", compositor="(cumbia)",                  pdf="Ya se ha muerto mi abuelo - Trompete Bb.pdf",     source="omr", key_concert="", beats=2, beat_type=4, forma=["A", "B"]),
    dict(num=17, titulo="Yekermo Sew",               compositor="Mulatu Astatke",            pdf="Yekermo Sew - Trompete Bb.pdf",                   source="omr", key_concert="", beats=2, beat_type=4, forma=["A", "B"]),
]
